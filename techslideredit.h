...
private:
    ...
    void applyTechStyle()
    {
        ...
        QString lineEditStyle = QString(
                                    "QLineEdit {"
                                    "    background-color: rgba(3, 15, 28, 225);"
                                    "    border: 1px solid %1;"
                                    "    border-radius: 8px;"
                                    "    padding: 7px 10px;"
                                    "    font-family: 'Segoe UI', 'Microsoft YaHei';"
                                    ...
                                    "QLineEdit:focus {"
                                    "    border: 1px solid %3;"
                                    "    background-color: rgba(4, 22, 40, 245);"
                                    "}"
        ...
        QString sliderStyle = QString(
                                  ...
                                  "    border: 1px solid rgba(74, 190, 238, 0.34);"
                                  "    height: 8px;"
                                  "    background: qlineargradient(x1:0, y1:0, x2:1, y2:0, "
                                  "        stop:0 rgba(3, 15, 28, 220), "
                                  "        stop:1 rgba(10, 35, 58, 210));"
                                  "    border-radius: 4px;"
                                  "}"
                                  ...
                                  "    background: rgba(28, 48, 66, 120);"
                                  "    border: 1px solid rgba(120, 150, 170, 0.30);"
                                  "    height: 8px;"
                                  "    border-radius: 4px;"
                                  "}"
